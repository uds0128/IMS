                      ...
                      <tr>
                        <?php
                                ...
                                if ($_POST['cid']=='' and $_POST['cname']=='' and $_POST['cmno']=='') {
                                  $query= "SELECT * FROM btblcustomermst WHERE RecStatus=1";
                                  $run = mysqli_query($con,$query);
                                }
                                                     
                                else if($_POST['cid'] and $_POST['cname']=='' and $_POST['cmno']==''){
                                        $query= "SELECT * FROM btblcustomermst WHERE CustomerId LIKE $cid AND RecStatus=1";
                                        $run = mysqli_query($con,$query);
                                    }
                                    ...
                                    {
                                        $query="SELECT * FROM btblcustomermst WHERE CustomerName LIKE '%$cname%' AND RecStatus=1";
                                        $run=mysqli_query($con,$query);
                                    }

                                    elseif ($_POST['cid']=='' and $_POST['cname']=='' and $_POST['cmno']) {
                                        $query="SELECT * FROM btblcustomermst WHERE MobileNo LIKE '$cmno' AND RecStatus=1";
                                        $run=mysqli_query($con,$query);                       
                                    }
                                if($run->num_rows==0){
