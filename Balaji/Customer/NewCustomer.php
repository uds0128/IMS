...
<body>
   ...
   $sql = "SELECT max(CustomerId) FROM bTblCustomerMst";
...
if(isset($_POST['submit'])){
   ...
   error_reporting(E_ERROR | E_WARNING | E_PARSE);
         ...
         $myque = "SELECT CustomerId FROM btblcustomermst WHERE CustomerName LIKE '$temp' AND MobileNo LIKE '$cmno' AND GSTNo LIKE '$cgst' AND Email Like '$cemail'";
         ...
         elseif ($myque3 != 0){
            $myque4 = "SELECT RecStatus FROM btblcustomermst WHERE CustomerId=$myque3";
         ...
         //          }); }, 1);
            ...
            $que = "INSERT INTO btblcustomermst (CustomerName,MobileNo,Email,GSTNo,Address,CreatedDate,ModifiedDate,RecStatus) VALUES('$temp','$cmno','$cemail','$cgst','$caddress',NOW(),NOW(),1)";
