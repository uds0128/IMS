<?php
  ...
  $qu="SELECT * FROM btblcustomermst WHERE CustomerId='$update_record'";
...
<?php
  ...
  $cgst1=strtoupper($_POST['cgst']);
    ...
    $q="UPDATE btblcustomermst SET CustomerName = '$temp1',  MobileNo = '$mobile1', Email = '$email1' , Address ='$caddress1', GSTNo ='$cgst1', ModifiedDate = NOW() WHERE CustomerId = '$id1'";
