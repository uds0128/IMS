...
//                                $eid=$_POST['eid'];
                                ...
                                if ($_POST['edis']=='' and $_POST['eamt']=='' and $_POST['edate1']=='' and $_POST['']=='') {
                                 $query= "SELECT * FROM btblexpencemst WHERE RecStatus=1";
                                ...
                                elseif($_POST['edis'] and $_POST['eamt']=='' and $_POST['edate1']=='' and $_POST['edate2']=='')
                                    {
                                        $query="SELECT * FROM btblexpencemst WHERE Discription LIKE '%$edis%' AND RecStatus=1";
                                        $run=mysqli_query($con,$query);
                                    }

                                elseif ($_POST['edis']=='' and $_POST['eamt'] and $_POST['edate1']=='' and $_POST['edate2']=='') {
                                        $query="SELECT * FROM btblexpencemst WHERE Amount LIKE $eamt AND RecStatus=1";
                                        $run=mysqli_query($con,$query);                       
                                    }
                                elseif ($_POST['edis']=='' and $_POST['eamt']=='' and $_POST['edate1'] and $_POST['edate2']=='') {
                                        $query="SELECT * FROM btblexpencemst WHERE ExpanceDate LIKE '$edate1' AND RecStatus=1";
                                        $run=mysqli_query($con,$query);                       
                                    }
                                elseif ($_POST['edis']=='' and $_POST['eamt']=='' and $_POST['edate1'] and $_POST['edate2']) {
                                        $query="SELECT * FROM btblexpencemst WHERE ExpanceDate BETWEEN '$edate1' AND '$edate2' AND RecStatus=1";
                                        //echo $query;
                                        $run=mysqli_query($con,$query);                       
                                    }
                                if($run->num_rows==0){
