<?php
  ...
  $qu="SELECT * FROM btblexpencemst WHERE ExpanceId='$update_record'";
...
<?php
  ...
  $dis_1=$_POST['edis'];
    ...
    $q="UPDATE btblexpencemst SET Discription = '$dis_1',  ExpanceDate = '$date_1', Amount = '$amount_1',  ModifiedDate = NOW() WHERE ExpanceId = '$id1'";
