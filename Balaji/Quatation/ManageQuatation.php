                     ...
                     <tbody>
                      <?php
                                ...
                                if ($_POST['vid']=='' and $_POST['vname']=='' and $_POST['vmno1']=='' and $_POST['vmno2']==''){
                                  $query= "SELECT * FROM btblqutationmst WHERE RecStatus=1";
                                  $run = mysqli_query($con,$query);
                                }
                                                     
                                else if($_POST['vid'] and $_POST['vname']=='' and $_POST['vmno1']=='' and $_POST['vmno2']==''){
                                        $query= "SELECT * FROM btblqutationmst WHERE QutationId LIKE $vid AND RecStatus=1";
                                        $run = mysqli_query($con,$query);
                                ...
                                elseif($_POST['vid']=="" and $_POST['vname'] and $_POST['vmno1']=='' and $_POST['vmno2']=='')
                                    {
                                        $query="SELECT * FROM btblqutationmst WHERE Name LIKE '%$vname%' ANd RecStatus=1";
                                        $run=mysqli_query($con,$query);
                                ...
                                elseif ($_POST['vid']=='' and $_POST['vname']=='' and $_POST['vmno1'] and $_POST['vmno2']=='') {
                                        $query="SELECT * FROM btblqutationmst WHERE QDate LIKE '$vmno1' AND RecStatus=1";
                                        $run=mysqli_query($con,$query);
                                        
                                                               
                                    }
                                elseif ($_POST['vid']=='' and $_POST['vname']=='' and $_POST['vmno1'] and $_POST['vmno2']) {
                                        $query="SELECT * FROM btblqutationmst WHERE QDate BETWEEN '$vmno1' AND '$vmno2' AND RecStatus=1";
                                        $run=mysqli_query($con,$query);
