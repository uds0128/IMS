<?php
    ...
    $insertIntoQuotationMst =  "INSERT INTO bTblQutationMst (Name, QDate, TotalPrice, TotalGST, TotalAmount) VALUES ('".$name."', '{$date}', {$totalamount}, {$gstamount}, {$netamount})";
    ...
    if($result_insertIntoQuotationMst)
    {
        ...
        $insertIntoQuotationDetails = "INSERT INTO btblqutationdetails (ItemNo, Discription, Qty, Rate, Gst, QutationId) VALUES ";
        for($i = 0; $i<$n; $i++)
        {
