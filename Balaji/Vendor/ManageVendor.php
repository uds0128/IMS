                     ...
                     <tbody>
                      <?php
                                ...
                                if ($_POST['vid']=='' and $_POST['vname']=='' and $_POST['vmno']=='') {
                                  $query= "SELECT * FROM btblvendormst WHERE RecStatus=1";
                                  ...
                                  //       }
                                        ...
                                        $query= "SELECT * FROM btblvendormst WHERE VendorId LIKE $vid AND RecStatus=1";
                                        $run = mysqli_query($con,$query);
                                    }
                                    ...
                                    {
                                        $query="SELECT * FROM btblvendormst WHERE VendorName LIKE '%$vname%' AND RecStatus=1";
                                        $run=mysqli_query($con,$query);

                                        // $query2="SELECT count(*) FROM btblvendormst WHERE VendorName LIKE '%$vname%' AND RecStatus=1";
                                        // if ($query2='0') {
                                    ...
                                    elseif ($_POST['vid']=='' and $_POST['vname']=='' and $_POST['vmno']) {
                                        $query="SELECT * FROM btblvendormst WHERE MobileNo LIKE '$vmno' AND RecStatus=1";
                                        $run=mysqli_query($con,$query);
