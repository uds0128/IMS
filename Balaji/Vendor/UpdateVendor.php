<?php
  ...
  $qu="SELECT * FROM btblvendormst WHERE VendorId='$update_record'";
...
<?php
  ...
  $cgst1=strtoupper($_POST['vgst']);
    ...
    $q="UPDATE btblvendormst SET VendorName = '$temp1',  MobileNo = '$mobile1', Email = '$email1' , Address ='$caddress1', GSTNo ='$cgst1', ModifiedDate = NOW() WHERE VendorId = '$id1'";
