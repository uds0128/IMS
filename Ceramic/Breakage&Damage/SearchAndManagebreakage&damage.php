...
<!--                             <hr>
                        ...
                        <div class="row mt-3">
                            <div class="col-md-3">
                                ...
                                <input type="button" value="Close" style="margin-left: 8px;" name="close" id="close" class="btn btn-success" onclick="location.href = '../admin.php';">
                            </div>
                            <div class="col-md-1">
        ...
        $("#subcategories").on('change', function () {
            ...
            if (subcatid != "-1") {
                $.ajax({
                    ...
                    error: function (Data) {
                        console.log('Error In ./AddNewChallanAjax/getBrandsFromSubcategory.php  Ajax Call ' + Data);
                        swal("Something Went Wrong", '', 'error');
                    }
                });
                ...
                $.ajax({
                    ...
                    error: function (Data) {
                        console.log('Error In  ./AddNewChallanAjax/getGradesFromSubcategory.php Ajax Call ' + Data);
                        swal("Something Went Wrong", '', 'error');
                    }
                });
            }
