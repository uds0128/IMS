<?php
    ...
    $query="SELECT * from stockdetails join systable where stockdetails.SysId=systable.SysId and systable.ProductId=". $_POST['productid']." and VirtualQty>0 and RecStatus=true";
    //echo $query;
