                            ...
                            <div class="row">
                                <div class="col-md-6 mt-3">
                                        ...
                                        <input style="margin-left: 5px;" type="button" value="Reset" id="resetbtn"
                                            class="btn btn-primary">
                                        <input style="margin-left: 5px;" type="button" value="Close"  name="close" id="close" class="btn btn-primary" onclick="location.href = '../admin.php';">
