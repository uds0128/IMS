                     ...
                     <tbody>
                      <?php
                                ...
                                elseif($_POST['iid']=="" and $_POST['vname']=="" and $_POST['datet'] and $_POST['datef']=="")
                                    {
                                      //echo $datet;
                                        $query="SELECT * FROM tblinwardbillmst WHERE InwardDate LIKE '$datet' and RecStatus='A'";
                                       // echo $query;
                                        $run=mysqli_query($con,$query);
                                        
                                    }
                                elseif ($_POST['iid']=='' and $_POST['vname']=='' and $_POST['datet'] and $_POST['datef']) {
                                        $query="SELECT * FROM tblinwardbillmst WHERE InwardDate BETWEEN '$datet' AND '$datef' AND RecStatus='A'";
