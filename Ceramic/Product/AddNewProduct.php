               ...
               <div class="card card-primary" style="overflow-x:auto;">
                  ...
                  <div class="col-12">
                     ...
                     <center>
                        ...
                        <input type="Button" value="Close" id="close" class="btn btn-success" onclick="window.location.href = '../admin.php'">
                     </center>
   ...
   $(function () {
      ...
      $('#add_data').click(function () {
         ...
         if ($("#sizeRadio").prop('checked') == true) {
            ...
            dimension = dimensionFirst + " X " + dimensionSecond + " " + dimensionUnitSecond;
         }
