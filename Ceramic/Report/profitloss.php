...
// }
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-3">
                     <center><h4 id="val">Selling Profit: <?php echo "$maxprofit" ?> <!-- <input type="number" style="border: 0px" name="val" id="val" value="<?php echo "$maxprofit" ?>" readonly="" class="form-group"> --></h4></center>  
                    </div>
                    <div class="col-md-3">
                     <center><h4 id="val7">Dade Loss: <?php echo"$round" ?></h4></center>   
                    </div>
                    <div class="col-md-3">
                    <center><h4 id="val8">Pending Loss: <?php echo"$pending" ?></h4></center> 
                    </div>
                    <div class="col-md-3">
                    <center><h4 id="val9">Damage Loss: <?php echo "$damage" ?></h4></center> 
                    </div>
