...
<!--                            <th style="">Total Amount</th> -->
                     ...
                     <tbody>
                      ...
                      if ($_POST['vmno1']=='' AND $_POST['vmno2']=='') {
                        ...
                        $query="SELECT stockdetails.BillingQty, stockdetails.OtherQty, productmst.QtyPerUnit, brandnames.BrandName, categories.category_name, subcategories.subcategory_name, productmst.PackingUnit, productmst.SizeOrDimension, systable.BatchNo, stockdetails.DateAdded  FROM stockdetails join systable, productmst, subcategories, categories, brandnames WHERE stockdetails.SysId = systable.SysId and systable.ProductId = productmst.ProductID and productmst.ProductSubCategoryID = subcategories.subcategory_id and subcategories.category_id = categories.category_id and brandnames.BrandId=productmst.BrandId AND categories.active_status=1 AND subcategories.active_status=1 AND productmst.RecStatus=1 AND systable.RecStatus=1 AND (stockdetails.BillingQty>0 OR stockdetails.OtherQty>0)";
                    //  echo "$query";
